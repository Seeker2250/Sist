...
//    사용법은 같은데 multi thread에
//    StringBufer는 안전, StringBuilder는 안전하지 않다.
//    동기화처리 StringBufer는 되어있어. StringBuilder는 안되어있어.
...
//    문자열을 String이라는 class type으로 +=연결하는 코딩은 하면 안되는 안좋은 거
  }//main
}//class
